...
from trajectory_msgs.msg import MultiDOFJointTrajectory, JointTrajectory, JointTrajectoryPoint
...
class UavExplorationSm:
  ...
  def __init__(self):
    ...
    self.trajectory_pub = rospy.Publisher('exploration/joint_trajectory', JointTrajectory, 
      queue_size=1)
